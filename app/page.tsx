      ...
      <div className="card p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
          ...
          <div className="text-center p-4 bg-yellow-50 rounded-lg">
            ...
            <p className="text-sm text-gray-600">Тренуйтесь з усіма словами з усіх наборів одночасно</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div>
            ...
            <ul className="text-gray-600 space-y-2">
              <li>• <strong>Спеціальна опція</strong> для тренування з усіма словами</li>
              <li>• <strong>Ексклюзивний вибір</strong> - не можна комбінувати з іншими наборами</li>
              <li>• <strong>Загальна статистика</strong> по всіх вивчених словах</li>
              <li>• <strong>Ідеально для повторення</strong> всього матеріалу</li>
            </ul>
          </div>
          <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div>
            ...
            <ul className="text-gray-600 space-y-2">
              ...
              <li>• <strong>Всі слова:</strong> Загальна статистика по всіх наборах разом</li>
